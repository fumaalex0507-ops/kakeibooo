...
import { FIXED_COST_ONLY_CATEGORY_IDS, type Category } from "@/lib/types";
...
export default async function InputPage() {
  ...
  const inputCategories = ((categories ?? []) as Category[]).filter(
  ...
  return (
    <div>
      ...
      <TransactionForm categories={inputCategories} />
    </div>
  );
}
